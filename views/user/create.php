                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="username" name="username"
                               placeholder="Introduza o nome..." value="<?php if (isset($user)) {
                            echo $user->username;
                        } ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" id="password" name="password"
                               placeholder="Introduza a password..." value="<?php if (isset($user)) {
                            echo
                            $user->password;
                        } ?>">
                        <?php if (isset($user->errors)) {
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="email" name="email"
                               placeholder="Introduza o email..." value="<?php if (isset($user)) {
                            echo
                            $user->email;
                        } ?>">
                        <?php if (isset($user->errors)) {
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="telefone" name="telefone"
                               placeholder="Introduza o telefone..." value="<?php if (isset($user)) {
                            echo
                            $user->telefone;
                        } ?>">
                        <?php if (isset($user->errors)) {
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="nif" name="nif" placeholder="Introduza o NIF..."
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="morada" name="morada"
                               placeholder="Introduza a morada..." value="<?php if (isset($user)) {
                            echo
                            $user->morada;
                        } ?>">
                        <?php if (isset($user->errors)) {
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="codigopostal" name="codigopostal"
                               placeholder="Introduza o código postal..." value="<?php if (isset($user)) {
                            echo
                            $user->codigopostal;
                        } ?>">
                        <?php if (isset($user->errors)) {
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="localidade" name="localidade"
                               placeholder="Introduza a localidade..." value="<?php if (isset($user)) {
                            echo
                            $user->localidade;
                        } ?>">
                        <?php if (isset($user->errors)) {
